...
export default class BookRequestScreen extends Component{
  ...
  addRequest =(bookName,reasonToRequest)=>{
    ...
    var books =  BookSearch.searchBook(bookName,'AIzaSyCmGhbhDtWKy6dWxMOk7tYptfC6drreh7I');
  ...
  async GetBooksFromAPI(bookName){
    ...
    if(bookName.length>2){
      var books  = await BookSearch.searchBook(bookName,'AIzaSyCmGhbhDtWKy6dWxMOk7tYptfC6drreh7I');
      this.setState({
